            ...
            <SafeAreaView style={styles.containerSafeArea}>
                ...
                <View style={styles.container}>
                    {order && order.product.imagesProducts.length > 0 ? (
                        <ImageProductDetail image={{uri: order.product.productImage}} images={order.product.imagesProducts}/>
                    ) : null}
                    ...
                    <View style={styles.productDetailsContainer}>
                        ...
                        <View style={[styles.colorContainer, {backgroundColor: order.color} ]}/>
                    </View>
                </View>
            </ScrollView>
